...
import design.patterns.factory.EnemyShipFactory;
...
public class TestingReflection {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            constructor = reflectClass.getConstructor(new Class[]{design.patterns.abstractfactory.EnemyShipFactory.class});
        ...
        design.patterns.abstractfactory.EnemyShipFactory shipFactory = null;
